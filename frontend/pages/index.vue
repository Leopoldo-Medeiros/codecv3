<template>
  ...
  <main class="mx-4 my-16">
    ...
    <div class="flex flex-col items-center justify-center mt-32 space-y-8 lg:flex-row lg:items-stretch lg:space-x-8 lg:space-y-0">
      <!-- Basic Card-->
      <div class="carousel rounded-box w-80 p-8 bg-white text-center rounded-3xl pr-16 shadow-xl duration-300 hover:scale-110">
      ...
      <!-- Standard -->
      <div class="relative w-80 p-8 bg-gray-900 text-center rounded-3xl text-white pr-16 shadow-xl lg:w-80 lg:transform lg:scale-110 transform transition duration-300 hover:scale-125">
      ...
      <!-- Premium -->
      <div class="w-80 p-8 bg-white text-center rounded-3xl pr-16 shadow-xl duration-300 hover:scale-110">
